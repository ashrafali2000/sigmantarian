const BusinessCards = () => {
  return (
    <div className="relative h-[2000px]   overflow-hidden bg-[#6513857c]">
      ...
      {/* <div className="flex flex-col md:flex-row top-24 left-4 justify-center md:gap-16 gap-8  absolute lg:top-64 md:top-32 md:left-8 lg:left-40 ">
        <div className="text-white w-72  md:w-80  text-md  border py-5 px-3  rounded-3xl bg-[#760f9e69]  shadow-lg">
          <div className="flex items-center justify-between list-none">
            <li className="text-3xl xl:text-6xl font-semibold">Gold</li>
            <li>
              <img
                src="./0012-removebg-preview.png"
          ...
          <br />
          <p>
            Investors are to be empowered with a basic investment plan so that
            they can earn as much as possible from the platform.
          </p>
          <br />
        ...
        <div className="text-white w-72 md:w-80  text-md  border py-5 px-3  rounded-3xl bg-[#760f9e69]  shadow-lg">
          ...
          <br />
          <p>
            This is a basic package in Sigmantarian empowering those users who
            want to start career in affiliate marketing.
          </p>
          <br />
