              ...
              <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                <div className="relative bg-white rounded-lg shadow ">
                  <button
                    ...
                    type="button"
                    className="absolute top-3 right-2.5 bg-transparent  hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center "
                    ...
                    <ul className="my-4 space-y-3">
                      <li>
                        <a
                          ...
                          className="flex cursor-pointer items-center p-3 text-base font-bold text-gray-900 bg-gray-200 rounded-lg  group hover:shadow "
                        >
                          <svg
                            aria-hidden="true"
                            className="h-4"
                      ...
                      <li>
                        <a
                          ...
                          className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-200 rounded-lg  group hover:shadow "
                        >
                          <svg
                            aria-hidden="true"
                            className="h-5"
                      ...
                      <li>
                        <a
                          onClick={conToWallet}
                          className="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-200  rounded-lg hover:bg-gray-100 group hover:shadow"
                        >
                          <svg
                            aria-hidden="true"
                            className="h-7"
