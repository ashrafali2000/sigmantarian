...
const Binance = () => {
  return (
    <div className="bg-[#541d69]  h-[554px] lg:h-[738px] xl:h-[640px]  text-center  text-white  relative overflow-hidden">
...
{
  /* <img src="./0003-removebg-preview.png" className="w-60 absolute top-60" /> */
}
{
  /* <img
        src="./0005-removebg-preview.png"
        className="w-80 absolute top-10 right-10"
      /> */
}
{
  /* <img
        src="./0003-removebg-preview.png"
        className="w-72 absolute bottom-0 right-28"
      /> */
}
{
  /* <img
        src="./0004-removebg-preview.png"
        className="w-60 absolute -bottom-10"
      /> */
}
...
{
  /* <img src="./0001-removebg-preview.png" className="w-60 absolute top-0" /> */
}

{
  /*<img src="./0019-removebg-preview.png" className="w-60 absolute top-0" />*/
}
{
  /* <img src="./0001-removebg-preview.png" className="w-60 absolute top-0" /> */
}
...
{
  /* <div className="custom-radial-gradient rounded-full inset-0 backdrop-filter backdrop-blur-lg absolute bottom-0 left-0"></div> */
}
