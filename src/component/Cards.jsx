...
const Cards = () => {
  return (
    <div className="relative  h-[640px] flex  overflow-hidden multi-color-gradient2 ">
          ...
          <div className="flex flex-col gap-7">
            <div class=" transform hover:scale-110 rounded-lg group relative cursor-pointer overflow-hidden bg-white shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 ">
              ...
              >
                ...
                <div className="flex flex-col justify-between p-4 leading-normal">
                  <h5 className="mb-2 text-2xl font-bold z-10 tracking-tight text-gray-900 dark:text-white">
                    In-direct Bonus{" "}
                  </h5>
            ...
            <div class=" transform hover:scale-110 rounded-lg group relative cursor-pointer overflow-hidden bg-white shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 ">
              ...
              >
                ...
                /> */}
                <div className="flex flex-col justify-between p-4 leading-normal">
                  <h5 className="mb-2 text-2xl font-bold tracking-tight z-10 text-gray-900 dark:text-white">
                    Bonuses
                  </h5>
                  <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
          ...
          <div className="flex flex-col gap-7">
            <div class=" transform hover:scale-110 rounded-lg group relative cursor-pointer overflow-hidden bg-white shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 ">
              ...
              >
                ...
                /> */}
                <div className="flex flex-col justify-between p-4 leading-normal">
                  <h5 className="mb-2 text-2xl z-10 font-bold tracking-tight text-gray-900 dark:text-white">
                    Passive income{" "}
                  </h5>
                  <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            <div class=" transform hover:scale-110 rounded-lg group relative cursor-pointer overflow-hidden bg-white shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 ">
              ...
              >
                ...
                <div className="flex flex-col justify-between p-4 leading-normal ">
                  ...
                  <p>
                    Every user and package holder <br />
                    will get a chance to perform task to increase <br /> there
                    earning from $0.01 to $1 dailyy.
                  </p>
                </div>
              </div>
            </div>
